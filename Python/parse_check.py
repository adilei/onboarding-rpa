...
def parseCheque(imagePath, referencePath):

        #imagePath = "C:/Users/Adi/Downloads/cheqify-python-master/cheqify-python-master/bank-check-ocr/cancelled_example.jpg"
        #imagePath = downloadURL(url)
        #referencePath = "C:/Users/Adi/Downloads/cheqify-python-master/cheqify-python-master/bank-check-ocr/micr_e13b_reference.png"
        ...
        for (gX, gY, gW, gH) in groupLocs:
                ...
                charCnts = cv2.findContours(group.copy(), cv2.RETR_EXTERNAL,
                        cv2.CHAIN_APPROX_SIMPLE)
                charCnts = charCnts[1] if imutils.is_cv3() else charCnts[0]
